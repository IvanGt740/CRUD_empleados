...
//DefaultTableModel tblModelo;
    ...
    private void initComponents() {
        ...
        tb_clientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombres", "Apellidos", "Direccion", "Telefono", "Fecha de N.", "Puesto"
            }
        ));
        ...
        txt_puesto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Elija Puesto", "Programador", "Analista" }));
        txt_puesto.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                txt_puestoItemStateChanged(evt);
            }
        });
        ...
        lbl_puesto.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
                ...
                .addGroup(panel_clientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(panel_clientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panel_clientesLayout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(txt_nit, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(panel_clientesLayout.createSequentialGroup()
                            .addGroup(panel_clientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panel_clientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(txt_apellidos, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
        ...
        panel_clientesLayout.setVerticalGroup(
            ...
            .addGroup(panel_clientesLayout.createSequentialGroup()
                ...
                .addGroup(panel_clientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btn_borrar))
                .addGap(18, 18, 18)
                .addComponent(panel_tabla_clientes, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE))
        );
    ...
    private void btn_crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_crearActionPerformed
        ...
        empleado = new Empleado(0,txt_nit.getText(), resultado, txt_nombres.getText(), txt_apellidos.getText(), txt_direccion.getText(), txt_telefono.getText(), txt_fn.getText());
        empleado.crear();
...
private void select_datos(){
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        // TODO add your handling code here:
        empleado = new Empleado(Integer.valueOf(lbl_id.getText()),txt_nit.getText(),resultado, txt_nombres.getText(), txt_apellidos.getText(), txt_direccion.getText(), txt_telefono.getText(), txt_fn.getText());
        empleado.actualizar();
        this.tb_clientes.setModel(empleado.leer());
    ...
    private void txt_puestoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_puestoActionPerformed
        // TODO add your handling code here:
        String cadena;
        cadena=txt_puesto.getSelectedItem().toString();
        
        if (cadena.equals("Programador")){
            resultado="1";
        }
        if (cadena.equals("Analista")){
            resultado="2";
        }
    ...
    private void txt_puestoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_txt_puestoItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_puestoItemStateChanged
